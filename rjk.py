...
mouth_cascade = cv2.CascadeClassifier('.\haar-cascade-files-master\haarcascade_mcs_mouth.xml')
upper_body = cv2.CascadeClassifier('.\haar-cascade-files-master\haarcascade_upperbody.xml')
...
while 1:
    ...
    # Convert image in black and whiteSS
